...
export const StyledTypography = ({
  ...
  const typographyColor: any = color
    ? color === 'secondary'
      ? { color: themes.light.Typography.Secondary }
      : { color: themes.light.Typography.main }
    : '';
  return (
    <TypographyStyle
      id={id}
      className={`${type + ' ' + variant + ' ' + weight + ' ' + align}`}
      style={Object.assign(style ? style : '', typographyColor)}
    >
      {html ? (
        <div
