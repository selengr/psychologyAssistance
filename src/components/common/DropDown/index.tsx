...
export const StyledDropDown = ({ id, defaultValue, placeholder, MenuProps, value, errorMsg, error, onClick, onChange, onBlur, label, required, disabled, labelAlign, multiple, ...props }: DropdownProps) => {
    return (
      <>
        {label && <StyledLabel error={error} required={required} disabled={disabled} align={labelAlign} value={label} />}
        <Select
          id={id}
          error={error}
